...
In applying the 1se rule, we are looking for the smallest tree below the dotted line (i.e., representing minimum cross-validation error + 1 standard error). The 1se rule allows us to select the smallest tree whose cross-validation error is within one standard error of the minimum based on this.
